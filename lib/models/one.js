...
module.exports = Backbone.Model.extend({
  ...
  history: function (from, direction, limit, callback) {
    this.app.client.userHistory(this.get('user_id'), from, direction, limit, callback);
  },
  markAsViewed: function () {
    this.app.client.userViewed(this.get('user_id'));
  },
  sendMessage: function (message, files) {
    this.app.client.userMessage(this.get('user_id'), message, files);
  },
