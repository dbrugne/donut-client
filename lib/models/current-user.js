...
module.exports = Backbone.Model.extend({
  ...
  initialize: function (data, options) {
    ...
    this.listenTo(this.app.client, 'notification:new',    this.updateUnreadCount);
    this.listenTo(this.app.client, 'notification:done',   this.updateUnreadCount);
    this.listenTo(this.app.client, 'notification:viewed', this.updateUnreadCount);
    this.listenTo(this.app.client, 'notification:read',   this.updateUnreadCount);
  ...
  onWelcome: function (data) {
    ...
    this.updateUnreadCount(data.notifications);
  ...
  updateUnreadCount: function(event) {
    this.set('unreadNotifications', event.unread);
  }
});
