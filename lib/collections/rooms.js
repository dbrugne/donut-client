...
module.exports = Backbone.Collection.extend({
  ...
  _onExpulsion: function (what, data) {
    ...
    // @todo yfuks c'est embétant d'avoir modifier du code dans collections/rooms.js sans l'avoir reporté
    //             dans le projet donut (le code est censé être commun), je fais quoi moi maintenant
    //             je le supprime ou le garde le code ci-dessous???
    // commit: https://github.com/dbrugne/donut-native/commit/8cbab67a940ccd9c9a138d71d4e26bd01be2ef72#diff-a3232fa35fd2620e2261fbe7a22fcbfc
    this.app.trigger('redrawNavigationRooms');
    if (isFocused) {
      this.app.trigger('focus', this.get(data.room_id));
    }
  },
