...
api.groupQuitMembership = function (groupId, callback) {
  var data = {group_id: groupId};
  this.pomeloRequest('chat.groupQuitMembership.call', data, callback);
};
...
api.groupBecomeMember = function (groupId, password, callback) {
  ...
  this.pomeloRequest('chat.groupBecomeMember.call', data, callback);
};
...
api.groupLeave = function (groupId, callback) {
  var data = {group_id: groupId};
  this.pomeloRequest('chat.groupLeave.call', data, callback);
};
